...
- Keep paid execution behind `--execute --confirm-spend`, a positive cost ceiling, and a validated client-local idempotency key; do not claim server retry deduplication for `POST /api/execute`.
